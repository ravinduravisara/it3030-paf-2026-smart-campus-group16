    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(authz -> authz
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/bookings/**", "/api/tickets/**", "/api/comments/**")
                        .hasAnyRole("USER", "ADMIN")
                        .requestMatchers(HttpMethod.PUT, "/api/bookings/**", "/api/tickets/**")
                        .hasAnyRole("USER", "ADMIN")
                        ...
                        .hasAnyRole("USER", "ADMIN")
                        .requestMatchers(HttpMethod.PATCH, "/api/bookings/*/decide")
                        .hasRole("ADMIN")
                        .requestMatchers(HttpMethod.PATCH, "/api/tickets/*/status")
                        .hasAnyRole("USER", "ADMIN")
                        .requestMatchers(HttpMethod.PATCH, "/api/tickets/*/assign")
                        .hasRole("ADMIN")
                        .requestMatchers(HttpMethod.PUT, "/api/tickets/*/comments/*")
                        .hasAnyRole("USER", "ADMIN")
                        .requestMatchers(HttpMethod.DELETE, "/api/tickets/*/comments/*")
                        .hasAnyRole("USER", "ADMIN")
